...
extension Wistia {
    ...
    public func showVisitors(search: String, page: Int, completionHandler: @escaping ([Stats.Visitor]?, Error?) -> Void) {
        let route: Wistia.Stats.Route = .visitors
        let request = createRequest(route: route, httpMethod: .get, queryParams: [
            "search": search,
            "per_page":"100",
    ...
    public func showEventsForVisitor(visitorKey: String, page: Int, completionHandler: @escaping ([Stats.Event]?, Error?) -> Void) {
        let route: Wistia.Stats.Route = .events
        let request = createRequest(route: route, httpMethod: .get, queryParams: [
